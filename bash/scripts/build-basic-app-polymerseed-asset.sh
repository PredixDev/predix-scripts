...
# ********************************** MAIN **********************************
function build-basic-app-polymerseed-asset-main() {
  ...
  echo "--------------------------------------------------"  >> $SUMMARY_TEXTFILE
  echo "Installed a front-end named $FRONT_END_POLYMER_SEED_APP_NAME and updated the property files and manifest.yml with UAA and Asset info" >> $SUMMARY_TEXTFILE
  ...
  echo "" >> $SUMMARY_TEXTFILE
  echo -e "You can execute 'px env "$FRONT_END_POLYMER_SEED_APP_NAME"' to view info about your front-end app, UAA and Asset" >> $SUMMARY_TEXTFILE
