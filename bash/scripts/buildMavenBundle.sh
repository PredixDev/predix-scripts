...
#SOLUTION_INI="sed -i 's#{MACHINE_BUNDLE_JAR}#${MACHINE_BUNDLE}#' config/solution.ini > $MACHINE_HOME/machine/bin/vms/solution.ini"
...
#__echo_run "sed \"s#MACHINE_BUNDLE_JAR#$MACHINE_BUNDLE#\" \"config/solution.ini\" > $MACHINE_HOME/machine/bin/vms/solution.ini"
